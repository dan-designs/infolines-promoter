...
export default function UpdatePassword() {
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    // Best Practice: Frontend validation before hitting the database
    ...
    if (error) {
      ...
      setStatus('success');
      setMessage('CREDENTIALS REWRITTEN. REDIRECTING...');
      
      // Give them a second to read the success message before kicking them to the dashboard
      setTimeout(() => {
        navigate('/dashboard');
      }, 2000);
    }
